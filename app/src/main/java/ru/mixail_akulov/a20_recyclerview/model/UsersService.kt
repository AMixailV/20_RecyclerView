package ru.mixail_akulov.a20_recyclerview.model
...
class UsersService {
    ...
    fun deleteUser(user: User) {
        // есди индекс будет найден, то он помещен в ссылку, иначе будет -1
    ...
    fun moveUser(user: User, moveBy: Int) {
        ...
        Collections.swap(users, oldIndex, newIndex) // перестановка элементов коллекции местами
        notifyChanges()
    }
